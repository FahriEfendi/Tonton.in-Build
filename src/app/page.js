  ...
  >
    ...
    >
      ...
      <p className="text-sm text-white sm:text-base lg:text-sm xl:text-sm xl:text-sm  xl:text-slate-300 flex items-center" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
        <FaListUl style={{ marginRight: '0.25rem' }} />{' '}
        <span style={{ marginLeft: '0.25rem' }}>{video.id_episode}</span>
      </p>
    </div>
    <div
    ...
    <div className="min-h-full bg-[#101633]">
      ...
      <main className="container mx-auto max-w-screen-lg border-1 bg-[#1c1f46] p-7 mb-4 mt-5 rounded">
        <div className="container mx-auto max-w-3/4 border-1 bg-sky-600 p-4 mb-4 rounded">
          <p>Selamat Datang Di Website Kami menyediakan video terbaru setiap hari.</p>
        </div>
